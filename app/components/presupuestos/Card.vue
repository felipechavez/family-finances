...
<style scoped>
.card { background: #18182a; border: 1px solid #2a2a40; border-radius: 18px; padding: 14px 16px; margin-bottom: 10px; }
.card--sobre { border-color: #5a2a2a; }

.header { margin-bottom: 8px; }
.cat-nombre { display: flex; align-items: center; gap: 8px; }
.cat-emoji { font-size: 20px; }
.cat-label { font-size: 14px; font-weight: 600; color: #f0eeff; }
.badge-excedido { background: rgba(239,68,68,0.15); color: #f87171; border-radius: 100px; padding: 2px 8px; font-size: 10px; font-weight: 600; }

.stats { display: flex; justify-content: space-between; font-size: 12px; color: #6b6b8a; margin-bottom: 8px; }
.texto-rojo { color: #f87171; }
.texto-morado { color: #a78bfa; }

.barra-track { height: 6px; background: #2a2a40; border-radius: 100px; overflow: hidden; margin-bottom: 10px; }
.barra-fill { height: 100%; border-radius: 100px; transition: width 0.6s cubic-bezier(.34,1.56,.64,1); }

.input-row { display: flex; gap: 8px; align-items: center; }

.input-limite {
  flex: 1; background: #0f0f18; border: 1.5px solid #2a2a40; border-radius: 12px;
  padding: 9px 12px; font-size: 14px; color: #f0eeff; outline: none;
}
.input-limite:focus { border-color: #7c3aed; }
