...
declare global {
  ...
  // @ts-ignore
  export type { User, AuthResponse, LoginInput, RegisterInput, FamilyRole, Family, FamilyMember, AccountType, Account, AccountCreateInput, AccountUpdateInput, TipoMovimiento, CategoriaGastoId, CategoriaIngresoId, CategoriaId, Transaccion, TransaccionCreateInput, Presupuesto, RecurrenceType, RecurringTransaction, ResumenMes, TendenciaMensual, ApiResponse, PaginatedResponse } from '../../shared/types/finanzas'
  import('../../shared/types/finanzas')
}
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'C:/dev/family-finances/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'C:/dev/family-finances/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { defineI18nLocale, defineI18nConfig } from 'C:/dev/family-finances/node_modules/@nuxtjs/i18n/dist/runtime/composables/shared';
export { defineI18nLocaleDetector } from 'C:/dev/family-finances/node_modules/@nuxtjs/i18n/dist/runtime/composables/server';
